      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center gap-3 bg-accent/20 backdrop-blur-sm text-primary px-6 py-3 rounded-full text-sm font-bold shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="group bg-accent text-textDark hover:bg-accent/90 px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 flex items-center justify-center shadow-2xl hover:shadow-accent/25 hover:scale-105">
            ...
            <div className="flex items-center gap-8 pt-8 border-t border-textLight/20">
              <div className="text-center">
                <div className="text-3xl font-black text-accent">25K+</div>
          ...
          <div className="relative lg:pl-8">
            <div className="relative">
              ...
              <div className="relative aspect-square lg:aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-textLight/10 to-accent/10 backdrop-blur-sm border border-textLight/20 p-6">
              ...
              {/* Floating AI Badge */}
              <div className="absolute -top-6 -right-6 bg-gradient-to-r from-accent to-accent/80 text-textDark px-6 py-3 rounded-2xl shadow-2xl flex items-center gap-3 font-black text-sm animate-bounce">
                <Sparkles className="w-5 h-5" />
                AI Powered
              </div>
              
              {/* Decorative Elements */}
              <div className="absolute -bottom-8 -left-8 w-20 h-20 bg-accent/30 rounded-full blur-2xl animate-pulse"></div>
              <div className="absolute -top-8 -left-6 w-16 h-16 bg-textLight/20 rounded-full blur-xl animate-pulse delay-1000"></div>
              <div className="absolute top-1/2 -right-4 w-12 h-12 bg-accent/40 rounded-full blur-lg animate-pulse delay-500"></div>
            </div>
          </div>
        </div>
      </div>
